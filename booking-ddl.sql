...
SELECT * From hotels_collections;
...
ADD COLUMN image json  after lng;

INSERT INTO landmarks(name,lat,lng,province_code,district_code,ward_code) VALUES
    ('Hồ Con Rùa',10.7827842,106.6944262,79,770,27151),
    ('Landmark81',10.7952219,106.7169203,79,765,26908),
    ('Nhà thờ Đức Bà Sài Gòn',10.7797855,106.696444,79,760,26737),
    ('Dinh Độc Lập',10.7769942,106.6927272,79,760,26737),
    ('Bãi Sau',10.3532904,107.0993267,77,747,26506);
...
SELECT * FROM hotels_collection_details;
